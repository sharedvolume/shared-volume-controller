...
func (in *S3SourceSpec) DeepCopyInto(out *S3SourceSpec) {
	*out = *in
	if in.AccessKeyFromSecret != nil {
		in, out := &in.AccessKeyFromSecret, &out.AccessKeyFromSecret
		*out = new(SecretKeySelector)
		**out = **in
	}
	if in.SecretKeyFromSecret != nil {
		in, out := &in.SecretKeyFromSecret, &out.SecretKeyFromSecret
		*out = new(SecretKeySelector)
		**out = **in
	}
}
